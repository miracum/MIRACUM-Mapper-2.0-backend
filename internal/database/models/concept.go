...
type Concept struct {
	...
	CodeSystem          CodeSystem // not preloaded on get
	...
	ValidFromVersion    CodeSystemVersion // not preloaded on get
	ValidToVersionID    int32             `gorm:"index;type:integer"`
	ValidToVersion      CodeSystemVersion // not preloaded on get
	//Elements            []Element
